...
The videos were recorded with the historical nine-stage feed sequence and an
operator approving each cycle. They do not demonstrate the current `feed-auto`
runtime. Each preview preserves its selected source interval at uniform 4×
...
To regenerate these two previews from the original recordings:
